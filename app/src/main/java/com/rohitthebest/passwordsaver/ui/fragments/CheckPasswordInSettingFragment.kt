...
@AndroidEntryPoint
class CheckPasswordInSettingFragment : DialogFragment() {
        ...
        confirmBtn.setOnClickListener {
            ...
            try {
                ...
                if (dialogPasswordET?.editText?.text.toString().trim().isNotBlank()) {
                    ...
                    Functions.showToast(requireContext(), "No password entered!!!")
                    dismiss()
                }
    ...
    private fun sendMessage(message: String) {
        ...
        try {
            ...
            e.printStackTrace()
            Functions.showToast(requireContext(), "Something went wrong!!!")
        }
    }

    fun getInstance(): CheckPasswordInSettingFragment {

        return CheckPasswordInSettingFragment()
    }
}